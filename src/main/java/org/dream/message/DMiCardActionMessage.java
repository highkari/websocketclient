 ...
 *  咪牌动作消息 
 */
public class DMiCardActionMessage extends TableMessage
{
	/**
	 *  开牌时的变量，发牌顺序
	 */
	...
	public DMiCardActionMessage()
	{
		this.m_iType = D_MICARD_ACTION_MESSAGE;
	}

	public DMiCardActionMessage(long tableid, int order, double mouseX, double mouseY, int ARROW)
	{
		this.m_iType = D_MICARD_ACTION_MESSAGE;
		m_lTableid = tableid;
		m_iOrder = order;
	...
	{
		return "DMiCardActionMessage<>";
	}

	public String toString()
	{
		return "DMiCardActionMessage<" + "tableid:" + m_lTableid + ", " + "order:" + m_iOrder + ", " + "mouseX:" + m_dMouseX + ", " + "mouseY:" + m_dMouseY + ", " + "ARROW:" + m_iARROW + ">";
	}
}